<%@ Control Language="c#" AutoEventWireup="false" Inherits="Bet.JellyPot.Admin.TextField" %>
...
<app:div runat="server" id="divItem" class="item clearfix">
  ...
  <div class="var">
		<app:textarea runat="server" id="txMain" class="txt txText jTxAreaResizable" />
		<app:div runat="server" id="lbRestHelp" tag="p" class="tip icon-bubble"><adm:text runat="server" textNode="Misc/HelpRest" /></app:div>
