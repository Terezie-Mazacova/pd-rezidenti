<%@ Control Language="c#" AutoEventWireup="false" Inherits="Bet.JellyPot.Admin.TinyTextField" %>
...
<app:div runat="server" id="divItem" class="item clearfix jTinyText">
  <span class="title">
    <app:span runat="server" id="lbFieldTitle" tag="" />
		<app:span runat="server" id="lbFieldDesc" tag="span" class="desc" />
  </span>
  <div class="var">
		<app:textarea runat="server" id="txMain" class="txt txText" />
