<%@ Control Language="c#" AutoEventWireup="false" Inherits="Bet.JellyPot.Admin.DateTimeField" %>
...
<app:div runat="server" id="divItem" class="item clearfix">
  ...
  <div class="var">
    <app:input runat="server" id="txDatum" class="txt txDate" />, <app:input runat="server" id="txCas" class="txt txTime" />
