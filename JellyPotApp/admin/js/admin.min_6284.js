...
c.submit())}},a.OpenVariable=function(a,b){var c="main.aspx?v="+a+"&l="+lang;b&&(c+="&b="+b),
document.location.href=c},a.AddVariable=function(a,b){var c="main.aspx?a="+a+"&l="+lang;
b&&(c+="&b="+b),document.location.href=c},a.OpenControl=function(a){document.location.href="main.aspx?c="+a+"&l="+lang;
},a.ConfirmDeleteVar=function(){return confirm(msgConfirmVarDelete)},a.OpenSpammer=function(a){
document.location.href="main.aspx?s="+a+"&l="+lang},a.OpenSpammerAkce=function(a,b,c){
var d="main.aspx?s="+spamName+"&l="+lang+"&p1="+a+"&p2="+b;c&&(d+="&p3="+c),document.location.href=d;
},a.QuestionReset=function(){confirm(msgQuestionReset)&&(document.forms[0].hQAAkce.value=9,
document.forms[0].submit())},a.SimpleImgEdit=function(b,c,d){var e="imgSimpleLoad.aspx?t="+b+"&f="+c+"&i="+d;
a.DialogOpen(e,{width:902,height:452,closeText:"×"})},a.ImgEdit=function(b,c,d){var e="imgLoad.aspx?t="+b+"&f="+c+"&i="+d;
a.DialogOpen(e,{width:902,height:452,closeText:"×"})},a.ImgColEdit=function(b,c,d,e){
var f=document.forms[0];f[c+"Idx"].value=d,a.ImgEdit(b,c,e)},a.ImgColBulkAdd=function(b,c,d){
var e="imgColLoad.aspx?t="+b+"&f="+c;d&&(e=e+"&d="+d),a.DialogOpen(e,{width:902,height:452,
closeText:"×"})},a.SetImg=function(a,b){var c=document.forms[0],d=c[a];d&&d.value&&(d.value=b),
c.submit()},a.SetImgBulk=function(a,b){var c=document.forms[0],d=c[a+"-Action"],e=c[a+"-Params"];
d.value=1,e.value=b,c.submit()},a.ImgDelete=function(b){confirm(msgImgDeleteConfirm)&&a.SetImg(b,0);
},a.ImgColBulkDelete=function(a,b){var c=[];if($(".imgColItem.ui-selecting").each(function(){
e=this.id.split("-"),e[0]===b&&(c[c.length]=e[1])}),0===c.length)return void alert(msgImgNoSelected);
if(confirm(msgImgDeleteBulkConfirm)){var d=document.forms[0],e=d[b+"-Action"],f=d[b+"-Params"];
e.value=9,f.value=c.join(","),d.submit()}},a.FileEdit=function(b,c,d){var e="fileLoad.aspx?t="+b+"&f="+c+"&i="+d;
a.DialogOpen(e,{width:902,height:452,closeText:"×"})},a.FileColEdit=function(b,c,d,e){
var f=document.forms[0];f[c+"-idx"].value=d,a.FileEdit(b,c,e)},a.SetFile=function(a,b){
var c=document.forms[0],d=c[a];d&&d.value&&(d.value=b),c.submit()},a.FileDelete=function(b){
confirm(msgFileDeleteConfirm)&&a.SetFile(b,0)},a.DownloadFile=function(a){window.location.href="fileGet.aspx?i="+a;
};var b=function(a){for(var b=0;b<a.length;++b)if(a[b].selected)return a[b].value;
};a.OnLangChange=function(){var a="",c=document.forms[0].selJazyky;if(c){a=b(c);var d=window.location.href;
if(d.indexOf("l="+lang)>0)d=d.replace("l="+lang,"l="+a);else{var e="&";""===window.location.search&&(e="?"),
d+=e+"l="+a}window.location.href=d}},a.OnCollectionFilter=function(){var a=document.forms[0].selCategory;
if(a){var c=b(a),d=document.location.search,e="r="+c,f=d.replace(/r=\d*/,e);d===f&&(f=""===d?"?"+e:d+"&"+e),
document.location.href=document.location.pathname+f}},a.DialogOpen=function(a,b){
var c="d"+Math.floor(1e5*Math.random()),d='<div class="jDialog"><iframe src="'+a+'" name="'+c+'" /></div>';
...
f||(f="");var g=c.attr("data-fieldName");BetJs.Jelly.Admin.FileColEdit(f,g,e,d)},e=function(a){
...
var e=document.forms[0];e[b.name+"-selected"].value=BetJs.Tables.GetSelected(b.name),
e[b.name+"-target"].value=d===-1?d:c[d],e.submit()}};return b}(),$(document).ready(function(){
BetJs.Jelly.ImgCol.Ini(),BetJs.Jelly.Img.Ini()});var BetJs;BetJs||(BetJs={}),BetJs.Jelly||(BetJs.Jelly={}),
BetJs.Jelly.ImgCol=function(){var a={};a.Ini=function(){b(),c(),$(".imgColContainer.sortable").imgColSortable();
...
a+=f;a!==b;a+=f)BetJs.Utils.ArrContains(d,a)||e.push(a);return BetJs.Utils.ArrContains(d,b)||e.push(b),
e},u=function(){var e=d,f=0;if(a&&(f=1),b&&(f=2),d=void 0,a=void 0,b=void 0,$(".jDragPickerA tr").removeClass("dragOver"),
