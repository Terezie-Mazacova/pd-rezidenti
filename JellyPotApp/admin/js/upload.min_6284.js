...
BetJs.Jelly.Admin.ImgColEdit(e,f,g,h)}};return a}(),BetJs.Jelly.Img=function(){var a={};
...
403===a.status?h():n("BetJs: Unspecified error on upload start - 703")}})):fileId>0?void m():(parent&&parent.BetJs.Jelly.Admin.SetFile(fieldName,0),
...
parent&&(parent.BetJs.Jelly.Admin.SetFile(fieldName,a),c.Close())},error:function(a){
...
},dataType:"text",success:function(){c.Close()},error:function(a){403===a.status?h():n("BetJs: Unspecified error when saving data - 708");
...
v=0,setTimeout(H,200)))},H=function(){++v,parent&&parent.SetImg2?K():v<30&&setTimeout(H,200);
...
var a,b,c={};c.Ini=function(){var a=$(".jImgUploadForm");if(0!==a.length){var b=9e5;
a.fileupload({url:"imgLoad.ajax.aspx",maxChunkSize:b,add:e,fail:d,progressall:l,done:m
}),$(".jBtnUpload").attr("value",0===imgId?labelUpload:labelSave)}};var d=function(a,b){
if(b.jqXHR&&"FileTooLong"===b.jqXHR.responseText)$("#jUploadStatus").html(msgFileTooLong).addClass("resultErr"),
r();else{var c={maxRetries:120,retryTimeout:1e3,DoRetry:function(){$.ajax({url:"imgLoad.ajax.aspx",
data:{action:"sizeQuery",uploadId:b.formData.uploadId,fileIdx:b.formData.fileIdx},
dataType:"text",success:function(a){b.uploadedBytes=Number(a),b.data=null,b.submit();
},error:function(a){403===a.status?j():d(a,b)}})}},e=b.retries||0;if(e<c.maxRetries)return e+=1,
b.retries=e,void window.setTimeout(c.DoRetry,c.retryTimeout);p("BetJs: Unspecified error during upload - 701");
}},e=function(b,c){if(c.files.length>0){if(c.files.length>1)return void p("BetJs: Wrong implementation - 702");
$(".jBtnUpload").attr("value",labelUpload).removeAttr("disabled").removeClass("disabled"),
$("#jUploadStatus").html("&nbsp;").removeClass("resultErr"),g(c),a=c,maxFileLength>0&&c.files[0].size>1024*maxFileLength&&(p(msgFileTooLong),
$(".jBtnUpload").attr("disabled","disabled").addClass("disabled"))}},f=function(){},g=function(b){
var c=b.files[0],d="image/jpeg"===c.type;if(d)var e=window.loadImage(c,function(a){
h(c,e,a)},{maxWidth:imgPrevMaxW,maxHeight:imgPrevMaxH});else i(),a=void 0,$(".jBtnUpload").attr("disabled","disabled").addClass("disabled");
},h=function(a,b,c){$("#imgPreview").html(c);var d=BetJs.Jelly.UploadUtils.FileSizeAsText(a.size),e=b.naturalWidth,f=b.naturalHeight,g="<strong>"+a.name+"</strong><span>"+e+" x "+f+" px</span><span>"+d+"</span>";
$("#lbInfo").html(g)},i=function(){$.ajax({url:"loadUtils.ajax.aspx",data:{action:"imgBadContent"
},dataType:"text",success:function(a){$("#imgPreview").html(a)}}),$("#lbInfo").html("&nbsp;");
};c.UploadStart=function(){return a?(q(),void $.ajax({url:"imgLoad.ajax.aspx",data:{
action:"startUpload",typePath:typePath,fieldName:fieldName},dataType:"text",success:function(a){
b=a,k()},error:function(a){403===a.status?j():p("BetJs: Unspecified error on upload start - 703");
}})):imgId>0?void o():(parent&&parent.BetJs.Jelly.Admin.SetImg(fieldName,0),void c.Close());
...
parent&&parent.BetJs.Jelly.Admin.DialogClose(window.name)};var j=function(){BetJs.Jelly.UploadUtils.DenyDialog();
},k=function(){if(a){var c=a.files[0].fileName;c||(c=a.files[0].name),a.formData={
fileIdx:0,uploadId:b,fileName:c},a.submit()}},l=function(a,b){var c=Math.round(b.loaded/b.total*100),d=msgTrasferingData+" "+BetJs.Jelly.UploadUtils.FileSizeAsText(b.loaded)+" ("+c+" %)";
$("#jUploadStatus").html(d).removeClass("resultErr")},m=function(a,b){var c=Number(b.files[0].size)!==Number(b.result);
c?p("BetJs: Unspecified error during upload - 704"):n()},n=function(){var a="";document.forms[0].txAlt&&(a=document.forms[0].txAlt.value),
$("#jUploadStatus").html(msgServerSaving).removeClass("resultErr"),$.ajax({url:"imgLoad.ajax.aspx",
data:{action:"finishUpload",uploadId:b,alt:a},dataType:"text",success:function(a){
parent&&(parent.BetJs.Jelly.Admin.SetImg(fieldName,a),c.Close())},error:function(a){
if(403===a.status)j();else if(409===a.status){var b;try{b=JSON.parse(a.responseText);
}catch(a){}p(b?b.errMsg:"BetJs: Unspecified error on upload finish - 705")}else p("BetJs: Unspecified error on upload finish - 706");
}})},o=function(){document.forms[0].txAlt?$.ajax({url:"imgLoad.ajax.aspx",data:{action:"altEdit",
typePath:typePath,fieldName:fieldName,imgId:imgId,alt:document.forms[0].txAlt.value
},dataType:"text",success:function(){c.Close()},error:function(a){403===a.status?j():p("BetJs: Unspecified error when saving data - 708");
}}):c.Close()},p=function(a){$("#jUploadStatus").html(a).addClass("resultErr"),r();
},q=function(){$(".jHidding").addClass("hidden"),$("#btSave").attr("disabled","disabled"),
$(".jImgUploadForm").fileupload("option","add",f),$("#jButtons").hide()},r=function(){
$(".jHidding").removeClass("hidden"),$("#btSave").removeAttr("disabled"),$(".jImgUploadForm").fileupload("option","add",e),
$("#jButtons").show()};return c}(),$(document).ready(function(){BetJs.Jelly.ImgSimpleUpload.Ini();
});var BetJs;BetJs||(BetJs={}),BetJs.Jelly||(BetJs.Jelly={}),BetJs.Jelly.ImgSimpleUpload=function(){
var a,b,c={};c.Ini=function(){var a=$(".jImgSimpleUploadForm");if(0!==a.length){var b=9e5;
a.fileupload({url:"imgSimpleLoad.ajax.aspx",maxChunkSize:b,add:e,fail:d,progressall:l,
done:m}),$(".jBtnUpload").attr("value",0===imgId?labelUpload:labelSave)}};var d=function(a,b){
if(b.jqXHR&&"FileTooLong"===b.jqXHR.responseText)$("#jUploadStatus").html(msgFileTooLong).addClass("resultErr"),
s();else{var c={maxRetries:120,retryTimeout:1e3,DoRetry:function(){$.ajax({url:"imgSimpleLoad.ajax.aspx",
data:{action:"sizeQuery",uploadId:b.formData.uploadId,fileIdx:b.formData.fileIdx},
dataType:"text",success:function(a){b.uploadedBytes=Number(a),b.data=null,b.submit();
},error:function(a){403===a.status?j():d(a,b)}})}},e=b.retries||0;if(e<c.maxRetries)return e+=1,
b.retries=e,void window.setTimeout(c.DoRetry,c.retryTimeout);q("BetJs: Unspecified error during upload - 701");
}},e=function(b,c){if(c.files.length>0){if(c.files.length>1)return void q("BetJs: Wrong implementation - 702");
$(".jBtnUpload").attr("value",labelUpload).removeAttr("disabled").removeClass("disabled"),
$("#jUploadStatus").html("&nbsp;").removeClass("resultErr"),g(c),a=c,maxFileLength>0&&c.files[0].size>1024*maxFileLength&&(q(msgFileTooLong),
$(".jBtnUpload").attr("disabled","disabled").addClass("disabled"))}},f=function(){},g=function(b){
var c=b.files[0],d="image/jpeg"===c.type||"image/png"===c.type||"image/gif"===c.type||"image/svg+xml"===c.type,e=!1;
if(d)var f=window.loadImage(c,function(a){h(c,f,a)},{maxWidth:imgPrevMaxW,maxHeight:imgPrevMaxH
});else e||(i(),a=void 0,$(".jBtnUpload").attr("disabled","disabled").addClass("disabled"));
},h=function(a,b,c){$("#imgPreview").html(c);var d=BetJs.Jelly.UploadUtils.FileSizeAsText(a.size),e=b.naturalWidth,f=b.naturalHeight,g="<strong>"+a.name+"</strong><span>"+e+" x "+f+" px</span><span>"+d+"</span>";
"image/svg+xml"===a.type&&(g="<strong>"+a.name+"</strong><span>"+d+"</span>"),$("#lbInfo").html(g);
},i=function(){$.ajax({url:"loadUtils.ajax.aspx",data:{action:"simpleImgBadContent"
},dataType:"text",success:function(a){$("#imgPreview").html(a)}}),$("#lbInfo").html("&nbsp;");
};c.UploadStart=function(){return a?(r(),void $.ajax({url:"imgSimpleLoad.ajax.aspx",
data:{action:"startUpload",typePath:typePath,fieldName:fieldName},dataType:"text",
success:function(a){b=a,k()},error:function(a){403===a.status?j():q("BetJs: Unspecified error on upload start - 703");
}})):imgId>0?void o():(parent&&parent.BetJs.Jelly.Admin.SetImg(fieldName,0),void c.Close());
},c.RemoveImg=function(){confirm(msgDeleteConfirm)&&($.ajax({url:"loadUtils.ajax.aspx",
data:{action:"noImgContent"},dataType:"text",success:function(a){$("#imgPreview").html(a);
}}),imgId=0,a=void 0,$(".jBtnUpload").attr("value",labelSave))},c.Close=function(){
...
fileIdx:0,uploadId:b,fileName:c},a.submit()}},l=function(a,b){var c=Math.round(b.loaded/b.total*100),d=msgTrasferingData+" "+BetJs.Jelly.UploadUtils.FileSizeAsText(b.loaded)+" ("+c+" %)";
$("#jUploadStatus").html(d).removeClass("resultErr")},m=function(a,b){var c=Number(b.files[0].size)!==Number(b.result);
c?q("BetJs: Unspecified error during upload - 704"):n()},n=function(){var d=p();$("#jUploadStatus").html(msgServerSaving).removeClass("resultErr"),
...
c.Close())},error:function(a){if(403===a.status)j();else if(409===a.status){var b;
try{b=JSON.parse(a.responseText)}catch(a){}q(b?b.errMsg:"BetJs: Unspecified error on upload finish - 705");
}else q("BetJs: Unspecified error on upload finish - 706")}})},o=function(){var a=p();
...
},error:function(a){403===a.status?j():q("BetJs: Unspecified error when saving data - 708");
}})},p=function(){var a=document.forms[0],b={};return b.alt=a.txAlt?a.txAlt.value:"",
b.w=a.txWidth?a.txWidth.value:"",b.h=a.txHeight?a.txHeight.value:"",b.link=a.txLink?a.txLink.value:"",
b},q=function(a){$("#jUploadStatus").html(a).addClass("resultErr"),s()},r=function(){
$(".jHidding").addClass("hidden"),$("#btSave").attr("disabled","disabled"),$(".jImgSimpleUploadForm").fileupload("option","add",f),
$("#jButtons").hide()},s=function(){$(".jHidding").removeClass("hidden"),$("#btSave").removeAttr("disabled"),
$(".jImgSimpleUploadForm").fileupload("option","add",e),$("#jButtons").show()};return c;
}();